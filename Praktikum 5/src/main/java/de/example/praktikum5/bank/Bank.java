...
/**
 * Interface for a generic de.example.praktikum5.bank. Provides multiple methods to handle the interaction between
...
public interface Bank {
     ...
     */
    void createAccount(String account) throws AccountAlreadyExistsException, AccountAlreadyExistsException, IOException;
