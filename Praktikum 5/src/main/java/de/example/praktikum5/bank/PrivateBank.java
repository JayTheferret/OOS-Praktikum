...
/**
 * class for a de.example.praktikum5.bank. Provides multiple methods to handle the interaction between
...
public class PrivateBank implements Bank {
    ...
    /**
     * Adds an account with only a name and empty transaction list to the de.example.praktikum5.bank, using. If the account already exists,
     ...
     * if Account doesn't exists an exception is thrown
     *
     * @param account the account to be deleted
     * @throws AccountDoesNotExistException if account does not exists
     * @throws IOException
     */
    public  void deleteAccount(String account) throws AccountDoesNotExistException, IOException{
        ...
        var file = new File("./files/" + account + ".json");
        file.delete();
    }
     ...
     * @throws AccountAlreadyExistsException if accounts to be added already exist in de.example.praktikum5.bank
     */
